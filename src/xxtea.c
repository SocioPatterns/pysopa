...
decode(PyObject *self, PyObject *args)
{
	...
	if (PyObject_AsReadBuffer(encoded_buf_obj, (const void **) &data, &n) < 0)
		return NULL;
	...
	decoded_buf_obj = PyBuffer_New(n);
	if (decoded_buf_obj == NULL)
		return NULL;

    if ( PyObject_AsWriteBuffer(decoded_buf_obj, (void **) &v, &n) )
		return NULL;
...
encode(PyObject *self, PyObject *args)
{
	...
	if (PyObject_AsReadBuffer(cleartext_buf_obj, (const void **) &data, &n) < 0)
		return NULL;
	...
	encoded_buf_obj = PyBuffer_New(n);
	if (encoded_buf_obj == NULL)
		return NULL;

    if ( PyObject_AsWriteBuffer(encoded_buf_obj, (void **) &v, &n) )
		return NULL;
...
crc16(PyObject *self, PyObject *args)
{
	...
	if (PyObject_AsReadBuffer(buf_obj, (const void **) &buffer, &n) < 0)
		return NULL;
